...
<form method="POST" action="/admin/provinces/update/{{ $province['id'] }}" enctype="multipart/form-data" style="max-width:500px; background:#fff; padding:20px; border-radius:6px; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
    @csrf
